...
'  ~~~~~~~~~~~~
'
'  - Init(ByVal BTR0BTR1 As Int16, ByVal CANMsgtype As Integer, ByVal CANHwType As Integer, ByVal IO_Port As Int32, ByVal Interrupt As Int16)
'  - Close()  
'  - Status() 
...
#End Region
    ...
    Public Shared Function Init( _
        ByVal BTR0BTR1 As Int16, _
        ByVal CANMsgtype As Integer, _
        ByVal CANHwType As Integer, _
        ByVal IO_Port As Int32, _
        ByVal Interrupt As Int16) As Int32
    End Function
