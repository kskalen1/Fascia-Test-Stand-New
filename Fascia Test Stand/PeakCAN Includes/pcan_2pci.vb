...
'  - GetDLL2_Version(ByVal buffer As StringBuilder)
'  - ResetClient()
...
#End Region
	...
	'
    <DllImport("PCAN_2PCI.dll", EntryPoint:="GetDLL2_Version")> _
    Public Shared Function GetDLL2_Version(ByVal buffer As StringBuilder) As Integer
    End Function
