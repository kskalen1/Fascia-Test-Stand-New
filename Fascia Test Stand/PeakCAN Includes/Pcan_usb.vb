...
#End Region
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_Init")>
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_Close")>
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_Status")>
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_Write")>
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_Read")>
   ...
   '  Possible Errors:  NOVXD
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_VersionInfo")>
   ...
   '  Possible Errors:  NOVXD
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_SpecialFunktion")>
   ...
   ' 
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_ResetClient")>
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_MsgFilter")>
   ...
   '  Possible Errors: NOVXD
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="CAN_ResetFilter")>
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="SetUSBDeviceNr")>
   Public Shared Function SetUSBDeviceNr(ByVal DevNum As Long) As Integer
   End Function
   ...
   '
   <DllImport("C:\Rehau Fascia Test Stand\Fascia Test Stand\dlls\PCAN_USB.dll", EntryPoint:="GetUSBDeviceNr")>
   Public Shared Function GetUSBDeviceNr(ByRef DevNum As Long) As Integer
    End Function
End Class
