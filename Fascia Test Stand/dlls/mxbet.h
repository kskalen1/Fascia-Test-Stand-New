/*****************************************************************************
  ...
  DATE OF LAST EDIT:     $Date: 2015/10/12 12:30:36 $

  CHANGE:                $Log: mxbet.h,v $
  CHANGE:                Revision 1.6.1  2015/10/12 12:30:36  mreuter
  CHANGE:                - bugfix changed function BET_GetSensorInfo to get the complete sensor PartNumber to (string pProdNumber)
  CHANGE:                - addd  ERR_VOLTAGE_INTERNAL  (23) ->on Board Voltage Error
  CHANGE:
...
#define ERR_MISSING_FUNKTION           22	  //
#define ERR_VOLTAGE_INTERNAL           23	  //on Board Voltage Error

#define BET_MAX_ERRORS      (ERR_MISSING_FUNKTION)
...
extern "C"
{
 ...
 BET_API unsigned long BET_MIDDECL BET_GetSensorInfo(int nPlatformID, int address, string *pProdNumber, unsigned long *pYear, unsigned long *pWeek, unsigned long *pDay, unsigned long *pSerialNum);
